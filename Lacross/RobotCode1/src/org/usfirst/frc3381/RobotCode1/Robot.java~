...
//        camera2.setFPS(framerate2);
        ...
        chooser.addObject("Autonomous Command Right Only", new AutonomousCommandRightOnly());
        chooser.addObject("Autonomous Command Left Only", new AutonomousCommandLeftOnly());
...
//        RobotMap.driveBaseTalonSRXMasterRight.setSensorPhase(true);
        ...
        // Wrist Position
        Robot.wheelBlockGrabber.count = 100;
