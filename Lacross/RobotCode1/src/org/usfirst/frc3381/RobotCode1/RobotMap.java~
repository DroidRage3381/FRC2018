...
public class RobotMap {
    ...
    public static SpeedController wheelBlockGrabberSparkWrist;
    public static DigitalInput wheelBlockGrabberDigitalInputWrist;
    public static DoubleSolenoid wheelBlockGrabberDoubleSolenoidOpenClose;
    public static DigitalInput wheelBlockGrabberLimitSwitchWrist;
    ...
    public static void init() {
        ...
        wheelBlockGrabberSparkWrist = new Spark(3);
        LiveWindow.addActuator("WheelBlockGrabber", "Spark Wrist", (Spark) wheelBlockGrabberSparkWrist);
        wheelBlockGrabberSparkWrist.setInverted(false);
        wheelBlockGrabberDigitalInputWrist = new DigitalInput(6);
        LiveWindow.addSensor("WheelBlockGrabber", "Digital Input Wrist", wheelBlockGrabberDigitalInputWrist);
        
        wheelBlockGrabberDoubleSolenoidOpenClose = new DoubleSolenoid(6, 2, 3);
        LiveWindow.addActuator("WheelBlockGrabber", "Double Solenoid Open Close", wheelBlockGrabberDoubleSolenoidOpenClose);
        
        wheelBlockGrabberLimitSwitchWrist = new DigitalInput(7);
        LiveWindow.addSensor("WheelBlockGrabber", "Limit Switch Wrist", wheelBlockGrabberLimitSwitchWrist);
        
        liftSparkLift = new Spark(0);
        LiveWindow.addActuator("Lift", "Spark Lift", (Spark) liftSparkLift);
        liftSparkLift.setInverted(true);
        liftQuadratureEncoderLift = new Encoder(4, 5, true, EncodingType.k4X);
