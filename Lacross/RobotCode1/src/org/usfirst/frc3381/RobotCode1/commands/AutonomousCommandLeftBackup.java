 ...
 *
 */
public class AutonomousCommandLeftBackup extends ConditionalCommand {
	
	String gameData;

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
    public AutonomousCommandLeftBackup() {
      super(new AutonomousCommandSwitchLeft(), new AutonomousCommandScaleRightFromLeft());
