 ...
 *
 */
public class AutonomousCommandRightOnly extends ConditionalCommand {

	String gameData;

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
    public AutonomousCommandRightOnly() {
      super(new AutonomousCommandScaleRight(), new AutonomousCommandRightOnlyBackup());
