 ...
 *
 */
public class AutonomousCommandRightOnlyBackup extends ConditionalCommand {

	String gameData;

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
    public AutonomousCommandRightOnlyBackup() {
      super(new AutonomousCommandSwitchRight(), new AutonomousCommandCrossBaseLine());
