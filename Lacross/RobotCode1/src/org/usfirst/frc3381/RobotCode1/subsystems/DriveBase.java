...
public class DriveBase extends Subsystem {
	...
	public Integer wristDownSetpoint = 0;
	public Integer wristUpSetpoint = 25;
	public Integer wristHalfSetpoint = 12;
    ...
    public void initDefaultCommand() {
        ...
        setDefaultCommand(new CommandSafetyDrive());
    ...
    public void arcadeDrive2(double move , double rotate){
    	drive.arcadeDrive(move, rotate * 0.85, true);
    }
