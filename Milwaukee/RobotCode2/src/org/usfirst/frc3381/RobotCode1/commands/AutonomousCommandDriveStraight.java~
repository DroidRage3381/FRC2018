...
public class AutonomousCommandDriveStraight extends Command {
    ...
    public AutonomousCommandDriveStraight(Double distance) {
...
//    	SmartDashboard.putNumber("Left Drive Encoder", Robot.driveBase.getLeftEncodeDistance());
    	...
    	if(distance - distanceRampDown <= Robot.driveBase.getRightEncodeDistance() && currentSpeed >= baseSpeed) {
//    		 || distance - distanceRampDown <= Robot.driveBase.getLeftEncodeDistance() && currentSpeed >= baseSpeed
    		rampDown = true;
    ...
    protected boolean isFinished() {
    	return Robot.driveBase.getRightEncodeDistance() >= distance;
//    	&& Robot.driveBase.getLeftEncodeDistance() >= distance
    }
