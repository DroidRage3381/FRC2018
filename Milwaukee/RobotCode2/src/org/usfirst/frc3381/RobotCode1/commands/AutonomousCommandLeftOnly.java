 ...
 *
 */
public class AutonomousCommandLeftOnly extends ConditionalCommand {
	
	String gameData;

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
    public AutonomousCommandLeftOnly() {
      super(new AutonomousCommandScaleLeft(), new AutonomousCommandLeftOnlyBackup());
