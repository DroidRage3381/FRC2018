...
public class RobotMap {
    ...
    public static SpeedController forkliftSparkLift;
    public static Encoder forkliftQuadratureEncoderLift;
    ...
    public static void init() {
        ...
        forkliftSparkLift = new Spark(0);
        LiveWindow.addActuator("Forklift", "Spark Lift", (Spark) forkliftSparkLift);
        forkliftSparkLift.setInverted(false);
        forkliftQuadratureEncoderLift = new Encoder(4, 5, false, EncodingType.k4X);
        LiveWindow.addSensor("Forklift", "Quadrature Encoder Lift", forkliftQuadratureEncoderLift);
        forkliftQuadratureEncoderLift.setDistancePerPulse(1.0);
        forkliftQuadratureEncoderLift.setPIDSourceType(PIDSourceType.kRate);
        ...
        wheelBlockGrabberSparkBlockGrabberRight.setInverted(false);
