...
public class AutonomousCommandDriveStraight extends Command {
    ...
    protected void initialize() {
    	...
    	maxSpeed = RobotMap.prefs.getDouble("Max Speed", 0.85);
    ...
    protected void execute() {
    	...
    	if(distance - 10 <= Robot.driveBase.getRightEncodeDistance() && currentSpeed >= baseSpeed || distance - 10 <= Robot.driveBase.getLeftEncodeDistance() && currentSpeed >= baseSpeed) {
