...
public class WheelBlockGrabber extends Subsystem {
	...
	Double wheelSpeed = RobotMap.prefs.getDouble("Wheel Speed", 1);
    ...
    public void grab(){
    	...
    	sparkBlockGrabberRight.set(-wheelSpeed);
    	sparkBlockGrabberLeft.set(-wheelSpeed * 0.75);
    ...
    public void release(){
    	...
    	sparkBlockGrabberRight.set(wheelSpeed);
    	sparkBlockGrabberLeft.set(wheelSpeed);
