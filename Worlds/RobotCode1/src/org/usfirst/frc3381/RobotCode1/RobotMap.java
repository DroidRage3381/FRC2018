...
public class RobotMap {
    ...
    public static SpeedController wristSparkWrist;
    public static GearTooth wristGearToothSensor1;
    ...
    public static void init() {
        ...
        wristSparkWrist = new Spark(3);
        LiveWindow.addActuator("Wrist", "Spark Wrist", (Spark) wristSparkWrist);
        wristSparkWrist.setInverted(false);
        wristGearToothSensor1 = new GearTooth(6, false);
        LiveWindow.addSensor("Wrist", "Gear Tooth Sensor 1", wristGearToothSensor1);
