 ...
 *
 */
public class AutonomousCommandLeft extends ConditionalCommand {
	
	String gameData;

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
    public AutonomousCommandLeft() {
      super(new AutonomousCommandScaleLeft(), new AutonomousCommandLeftBackup());
