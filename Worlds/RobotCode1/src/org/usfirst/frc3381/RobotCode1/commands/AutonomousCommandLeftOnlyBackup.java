 ...
 *
 */
public class AutonomousCommandLeftOnlyBackup extends ConditionalCommand {

	String gameData;

    // BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
    public AutonomousCommandLeftOnlyBackup() {
      super(new AutonomousCommandSwitchLeft(), new AutonomousCommandCrossBaseLine());
