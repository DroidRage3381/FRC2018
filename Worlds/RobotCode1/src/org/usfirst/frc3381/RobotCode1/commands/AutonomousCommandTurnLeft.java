 ...
 *
 */
public class AutonomousCommandTurnLeft extends Command {
    ...
    public AutonomousCommandTurnLeft(Double turnAngle) {
...
//    	SmartDashboard.putNumber("Left Drive Encoder", Robot.driveBase.getLeftEncodeDistance());
    	...
    	Double turnSpeed = RobotMap.prefs.getDouble( "Turn Speed", 0.55);
