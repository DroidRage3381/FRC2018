 ...
 *
 */
public class CommandSafetyDrive extends Command {
    ...
    protected void initialize() {
    	...
    	variant = RobotMap.prefs.getDouble("Robot Speed variant", 0.02);
    }
    ...
    protected void execute() {
    	...
    	if(liftHight <= Robot.lift.safeZone) {
    		...
    		if(currentMove <= setMove) {
    			currentMove = currentMove + (setMove - (variant * (liftHight - 15)));
