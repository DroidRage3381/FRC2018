...
import org.usfirst.frc3381.RobotCode1.subsystems.Wrist;
...
public class CommandWrist extends Command {
    ...
    protected void initialize() {
    	...
    	Robot.wrist.speed = 1.0;
    	
    	int povPosition = Robot.oi.gamepad1.getPOV();
    	
    	int desiredPosition;
    	switch(povPosition) {
    		case 0:
    			desiredPosition = Robot.wrist.positionUp;
    			break;
    		case 270:
    			desiredPosition = Robot.wrist.positionMid;
    			break;
    		case 180:
    			desiredPosition = Robot.wrist.positionDown;
    			break;
    		default:
    			desiredPosition = Robot.wrist.positionDown;
    			break;
