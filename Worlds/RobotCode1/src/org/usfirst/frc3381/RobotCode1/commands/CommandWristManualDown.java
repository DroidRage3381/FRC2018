 ...
 *
 */
public class CommandWristManualDown extends Command {
    ...
    protected void end() {
    	...
    	Robot.wrist.currentPosition = Robot.wrist.currentPosition - Robot.wrist.getCount();
